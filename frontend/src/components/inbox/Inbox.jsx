...
import { Search, RefreshCw, Mail, Clock, AlertCircle, CheckCircle } from 'lucide-react'
import { EmailContext } from '../../context/EmailContext'
import { emailApi } from '../../services/api'
import { CreditWarningBanner, PremiumPrompt } from '../premium/PremiumPrompt'
...
const Inbox = () => {
  ...
  }, [emails.length, checkCreditLimit])
  useEffect(() => {
    loadEmailAccounts()
  }, [loadEmailAccounts])
  useEffect(() => {
