      ...
      <div className="page-content p-5">
        ...
        {showForm && (
          <form
            ...
            className="mb-6 p-4 bg-slate-50 rounded-lg border border-slate-200 space-y-4"
          >
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 border border-slate-300 rounded-lg text-slate-700 bg-white hover:bg-slate-50 transition-colors"
              >
                <X className="h-4 w-4" />
                Cancel
              </button>
