  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <button onClick={() => navigate('/insights')} className="p-2 hover:bg-slate-100 rounded-lg">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-2 mt-2">
            <span
              className={`px-3 py-1 rounded text-sm font-medium border ${getSeverityColor(risk.severity)}`}
            >
              {risk.severity}
            </span>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-2xl font-bold text-slate-900">
                  {Math.round(risk.urgency_score || 0)}/100
                </p>
              </div>
              {risk.revenue_impact && (
                <div>
                  ...
                  <p className="text-xl font-semibold text-red-600">
                    -${risk.revenue_impact.toLocaleString()}
                  </p>
                </div>
              )}
              <div>
