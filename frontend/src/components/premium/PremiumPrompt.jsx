            ...
            <div className="banner-copy">
              <div className="banner-title">
                {percentage >= 100
                  ...
                  : `${Math.round(percentage)}% of your AI credits used`}
              </div>
              <div className="banner-sub">
                {currentUsage} / {monthlyLimit} credits used
              </div>
            </div>
          </div>
    ...
    <div className="premium-prompt-overlay">
      <div className="premium-prompt-modal">
        ...
        <div className="prompt-content">
          ...
          <button className="link-btn" onClick={() => navigate('/billing/upgrade?topup=1000')}>
            Buy 1,000 Credits ($4)
          </button>

          <button className="link-btn" onClick={() => onClose(limitType, false)}>
            Maybe Later
          </button>
        </div>
      </div>
...
export const SubscribeButton = ({
  ...
  if (variant === 'inline') {
    return (
      <button className="subscribe-button-inline" onClick={onClick}>
  ...
  return (
    <button className="subscribe-button-outline" onClick={onClick}>
