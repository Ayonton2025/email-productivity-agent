        ...
        {loading ? (
          ...
          <div className="text-center py-12 text-gray-500">
            ...
            <p className="text-gray-600 mb-6">
              Connect your email accounts to start using Bylix Email with your real emails
            </p>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center flex-wrap gap-2 mt-1">
                        <span
                          className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium border ${getProviderColor(account.provider)}`}
                        >
                  ...
                  {account.email_account_type === 'hosted_internal' && (
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-indigo-700">
                        ...
                        {account.send_limit_daily ? ` / ${account.send_limit_daily}` : ''}
                      </span>
                    </div>
                  )}
                </div>
