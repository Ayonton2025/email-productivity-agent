...
const Relationships = () => {
  ...
  const filteredCompanies =
    relationships?.companies?.filter((company) => {
      const matchesSearch =
        !searchTerm ||
  ...
  const filteredContacts =
    relationships?.top_contacts?.filter((contact) => {
      const matchesSearch =
        !searchTerm ||
        ...
        <div className="bg-white rounded-lg shadow p-6 border border-slate-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-3xl font-bold text-slate-900">{relationships?.total_companies || 0}</p>
            </div>
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        ...
                        {company.domain && <p className="text-sm text-slate-500 mt-1">{company.domain}</p>}
                      </div>
                      <span
                        className={`px-2 py-1 rounded text-xs font-medium border ${getStatusColor(company.relationship_status)}`}
                      >
                ...
                {filteredContacts.map((contact) => (
                  ...
                  >
                    <div className="flex items-center gap-4 flex-1">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2">
                          <h3 className="font-semibold text-slate-900">{contact.display_name || contact.email}</h3>
                        ...
                        {contact.job_title && <p className="text-sm text-slate-600 mt-1">{contact.job_title}</p>}
                    ...
                    <div className="text-right">
                      <span
                        className={`px-3 py-1 rounded text-sm font-medium border ${getStatusColor(contact.relationship_status)}`}
                      >
