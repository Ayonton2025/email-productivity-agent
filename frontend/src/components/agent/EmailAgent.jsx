...
const EmailAgent = () => {
  ...
  useEffect(() => {
    setMessages([{
      id: 1,
      type: 'agent',
      content: "Hello! I'm your Bylix Email assistant. I can help you prioritize conversations, summarize emails, extract tasks, and draft context-aware replies. How can I assist you today?",
