        ...
        <div className="bg-white py-8 px-6 shadow rounded-lg sm:px-10">
          <div className="grid grid-cols-2 gap-2 mb-5">
            <button
              ...
              className={`px-3 py-2 rounded-lg text-sm border ${mode === 'standard'
            ...
            <button
              ...
              className={`px-3 py-2 rounded-lg text-sm border ${mode === 'hosted'
                ? 'bg-indigo-600 text-white border-indigo-600'
                : 'bg-white text-gray-700 border-gray-300 hover:bg-gray-50'}`}
            >
              Get Bylix Email
          ...
          <form className="space-y-6" onSubmit={handleHostedSubmit}>
            <div>
              <label htmlFor="local_part" className="block text-sm font-medium text-gray-700">
                Bylix Email Username *
              </label>
              <div className="mt-1 relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  name="password"
                  type={showPassword ? 'text' : 'password'}
                  value={hostedData.password}
                  onChange={handleHostedChange}
                  className="appearance-none block w-full pl-10 pr-10 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  id="hosted_confirmPassword"
                  name="confirmPassword"
                  type={showPassword ? 'text' : 'password'}
                  value={hostedData.confirmPassword}
                  onChange={handleHostedChange}
                  className="appearance-none block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            ...
            <div>
              <button
                type="submit"
                disabled={loading}
                className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
              >
                <AtSign className="h-4 w-4 mr-2" />
                {loading ? 'Creating Bylix Email...' : 'Create Bylix Email'}
              </button>
            </div>
