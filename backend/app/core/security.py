...
def get_password_hash(password: str) -> str:
    ...
    try:
        ...
        logger.info("🔑 [Security] Password hashed successfully")
        return hashed
    except Exception as e:
...
def create_access_token(data: dict, expires_delta: Optional[timedelta] = None) -> str:
    ...
    try:
        ...
        logger.info(f"🔐 [Security] Access token created for user_id: {data.get('user_id')}")
        return encoded_jwt
    except Exception as e:
...
def verify_token(token: str) -> Optional[dict]:
    ...
    try:
        ...
        logger.info(f"✅ [Security] Token verified for user_id: {payload.get('user_id')}")
        return payload
...
def decrypt_credential(encrypted_credential: str) -> str:
    ...
    try:
        ...
        logger.error(f"❌ [Security] Credential decryption failed: {e}")
        raise
