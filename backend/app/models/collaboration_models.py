...
class SharedInboxMember(Base):
    ...
    __table_args__ = (Index("idx_shared_inbox_member_unique", "inbox_id", "user_id", unique=True),)
...
class SharedInboxEmail(Base):
    ...
    __table_args__ = (Index("idx_shared_inbox_email_unique", "inbox_id", "email_id", unique=True),)
