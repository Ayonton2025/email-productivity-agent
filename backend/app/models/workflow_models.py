...
class Workflow(Base):
    ...
    __table_args__ = (Index("idx_workflows_user_active", "user_id", "is_active"),)
...
class WorkflowStep(Base):
    ...
    __table_args__ = (Index("idx_workflow_order", "workflow_id", "step_order"),)
...
class Reminder(Base):
    ...
    __table_args__ = (Index("idx_reminder_user_due", "user_id", "due_at"),)
