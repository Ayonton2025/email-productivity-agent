...
from app.models.billing_models import AICredits, OutboundCredits, Subscription
        ...
        async with AsyncSessionLocal() as session:
            ...
            for subscription in subscriptions:
                try:
                    ...
                    subscription.renewal_date = datetime.utcnow() + timedelta(
                        days=subscription.billing_cycle == "monthly" and 30 or 365
                    )
                    renewed += 1
    ...
    try:
        async with AsyncSessionLocal() as session:
            ...
            result = await paystack.initialize_payment(
                ...
                metadata={"subscription_id": subscription_id, "plan_id": subscription.plan_id},
            )
