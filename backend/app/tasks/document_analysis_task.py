...
class DocumentAnalysisTaskHandler:
    ...
    async def analyze_attachment(self, attachment_id: str, user_id: str, user_plan: str = "free"):
        """
        ...
        if self.celery_enabled:
            ...
            analyze_attachment_task.apply_async(
                args=[attachment_id, user_id, user_plan], queue="document_analysis", priority=5
            )
    ...
    async def analyze_email_attachments(self, email_id: str, user_id: str, user_plan: str = "free"):
        """
...
if CELERY_AVAILABLE:
    ...
    def analyze_attachment_task(self, attachment_id: str, user_id: str, user_plan: str = "free"):
        """
    ...
    def analyze_email_attachments_task(self, email_id: str, user_id: str, user_plan: str = "free"):
        """
        ...
        try:
            ...
            return {"status": "success", "email_id": email_id, "attachments_processed": count}
...
if CELERY_AVAILABLE:
    ...
    def health_check_task():
        ...
        try:
            ...
            return {"status": "healthy", "celery_enabled": True}
        except Exception as e:
