...
async def get_email(
    ...
    try:
        ...
        return {"success": True, "data": email.to_dict()}
...
async def mark_as_read(
    ...
    try:
        ...
        return {"success": True, "message": f"Email marked as {'read' if is_read else 'unread'}"}
...
async def toggle_flag(
    ...
    try:
        ...
        return {"success": True, "message": f"Email {'flagged' if is_flagged else 'unflagged'}"}
...
async def get_category_stats(
    ...
    try:
        ...
        return {"success": True, "data": categories, "total": len(all_emails)}
