...
async def gmail_push_notification(
    ...
    try:
        ...
        background_tasks.add_task(handle_gmail_sync, email_address, history_id, db)

        return {"success": True, "message": "Push notification received, sync scheduled"}
...
async def handle_gmail_sync(email_address: str, history_id: str, db: AsyncSession):
    """
