...
class ConnectionManager:
    ...
    async def broadcast_email_received(
        self, user_id: str, email_id: int, email_data: Dict[str, Any], source: str = "gmail"
    ) -> None:
        """
    ...
    async def broadcast_email_read(self, user_id: str, email_id: int, is_read: bool) -> None:
        """
    ...
    async def broadcast_email_flagged(self, user_id: str, email_id: int, is_flagged: bool) -> None:
        """
    ...
    async def broadcast_sync_completed(
        self, user_id: str, account_email: str, emails_fetched: int, provider: str = "gmail"
    ) -> None:
        """
    ...
    async def broadcast_sync_error(
        self, user_id: str, account_email: str, error_message: str, provider: str = "gmail"
    ) -> None:
        """
