...
from app.models.contact_models import Company, Contact
...
async def get_risks(
    ...
    try:
        ...
        risks = await decision_service.get_active_risks(user_id=current_user.id, severity=severity)
...
async def get_relationships(
    ...
    try:
        ...
        # Get companies
        companies = await relationship_service.get_companies(user_id=current_user.id, status=status)
        ...
        contacts_result = await db.execute(
            ...
            .order_by(desc(Contact.relationship_score))
            .limit(50)
        )
...
async def get_analytics(
    ...
    try:
        ...
        return {
            ...
            "relationships": {"total_contacts": total_contacts, "total_companies": total_companies},
        }
    except Exception as e:
