...
class WorkflowEngine:
    ...
    async def trigger_workflows_for_email(
        self, email: Email, trigger_type: str = "email_received"
...
Respond with only "yes" or "no"."""
    ...
    async def execute_workflow(
        self, workflow: Workflow, email: Optional[Email], trigger_type: str
    ...
    async def execute_action(self, step: WorkflowStep, context: Dict[str, Any]) -> Dict[str, Any]:
