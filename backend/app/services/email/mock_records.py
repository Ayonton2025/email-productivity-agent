"""Original deterministic demonstration inbox, preserved from repository history."""
...
def fallback_records():
    return [
        ...
        },
        {
            ...
            "is_archived": False,
            "is_starred": False,
            "action_items": [{"task": "Complete benefits enrollment", "deadline": "2024-01-12", "priority": "high"}],
        ...
        },
        {
            ...
            "is_archived": False,
            "is_starred": False,
            "action_items": [{"task": "Consider AI Summit registration", "deadline": "2024-01-31", "priority": "low"}],
