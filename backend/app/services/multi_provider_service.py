...
class GmailProvider(BaseEmailProvider):
    ...
    async def setup_push_notifications(self, webhook_url: str) -> bool:
        ...
        try:
            ...
            # Watch the mailbox
            service.users().watch(userId="me", body={"topicName": webhook_url}).execute()

            logger.info("✅ Setup Gmail push notifications")
            return True
...
class MultiProviderService:
    ...
    @staticmethod
    def get_provider(
        provider_name: str, access_token: str, refresh_token: Optional[str] = None
