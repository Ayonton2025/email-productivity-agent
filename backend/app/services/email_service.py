    ...
    def _get_hardcoded_mock_emails(self) -> List[Dict[str, Any]]:
        ...
        return [
            ...
            },
            {
                ...
                "is_archived": False,
                "is_starred": False,
                "action_items": [{"task": "Respond to lunch invitation", "deadline": "2024-01-09", "priority": "low"}],
            ...
            },
            {
                ...
                "action_items": [
                    {
                        "task": "Evaluate software trial before expiration",
                        "deadline": "2024-01-11",
                        "priority": "medium",
                    }
                ],
            ...
            },
            {
                ...
                "is_archived": False,
                "is_starred": False,
                "action_items": [{"task": "Attend all-hands meeting", "deadline": "2024-01-12", "priority": "high"}],
            ...
            },
            {
                ...
                "is_archived": False,
                "is_starred": False,
                "action_items": [{"task": "Process invoice payment", "deadline": "2024-01-19", "priority": "medium"}],
            ...
            },
            {
                ...
                "is_archived": False,
                "is_starred": False,
                "action_items": [{"task": "Check in for flights", "deadline": "2024-01-19", "priority": "medium"}],
            ...
            },
            {
                ...
                "is_archived": False,
                "is_starred": False,
                "action_items": [{"task": "Track package delivery", "deadline": "2024-01-09", "priority": "low"}],
            ...
            },
            {
                ...
                "is_archived": False,
                "is_starred": False,
                "action_items": [{"task": "Prepare for Python workshop", "deadline": "2024-01-17", "priority": "low"}],
